...
for newcomers. Installing Django requires understanding how to install a specific Python runtime, how to create
a virtual environment for your project within the runtime environment, how to build and run the app, and how to
structure code.
